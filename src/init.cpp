...
void SetupServerArgs()
{
    ...
    // Add kafka options
    gArgs.AddArg("-kafka", "Bitcoin support kafka", false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-kafkaproxyhost=<ip>", "Kafka proxy host", false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-kafkaproxyport=<port>", "Kafka proxy port", false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-kafkatopic=<name>", "Kafka topic name", false, OptionsCategory::OPTIONS);
}
